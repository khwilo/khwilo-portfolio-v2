      ...
      <main className='section-wrapper main'>
        <div className='container'>
          <section id='about' className='section__main about'>
            ...
            <p>
              I am a software engineer with experience in the field of mobile
              web application development. I am passionate about bringing great
              ...
              time by sharing what I learn through writing technical articles
              and also assisting other developers in leveling up their skills.
            </p>
          </section>
          ...
          <section id='writing' className='section__main posts'>
            ...
            <div className='posts__wrapper'>
              ...
              >
                <article className='post'>
                  <h3 className='post_title'>
                    How to create full-screen drawer navigation in HTML, CSS,
                    and JavaScript
                  </h3>
